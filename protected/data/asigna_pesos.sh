	...
	if [ "$recomendacion" = "1" ]; then
		...
		case "$carta_nacional1" in
			...
			"En deterioro.")  let peso=peso+4
			    ;;
			"Máximo aprovechamiento permisible./ En deterioro.")  let peso=peso+4
			    ;;
			*) echo "No se reconocio el pez"
			   let peso=-1
			    ;;
		...
		case "$carta_nacional2" in
			...
			"En deterioro.")  let peso2=peso2+4
			    ;;
			"Máximo aprovechamiento permisible./ En deterioro.")  let peso2=peso2+4
			    ;;
			*) echo "No se reconocio el pez"
			   let peso2=-1
			    ;;
		...
		case "$carta_nacional3" in
			...
			"En deterioro.")  let peso3=peso3+4
			    ;;
			"Máximo aprovechamiento permisible./ En deterioro.")  let peso3=peso3+4
			    ;;
			*) echo "No se reconocio el pez"
			   let peso3=-1
			    ;;
		...
		case "$carta_nacional4" in
			...
			"En deterioro.")  let peso3=peso3+4
			    ;;
			"Máximo aprovechamiento permisible./ En deterioro.")  let peso4=peso4+4
			    ;;
			*) echo "No se reconocio el pez"
			   let peso4=-1
			    ;;
		...
		case "$carta_nacional5" in
			...
			"En deterioro.")  let peso5=peso5+4
			    ;;
			"Máximo aprovechamiento permisible./ En deterioro.")  let peso5=peso5+4
			    ;;
			*) echo "No se reconocio el pez"
			   let peso5=-1
			    ;;
		...
		case "$carta_nacional6" in
			...
			"En deterioro.")  let peso6=peso6+4
			    ;;
			"Máximo aprovechamiento permisible./ En deterioro.")  let peso6=peso6+4
			    ;;
			*) echo "No se reconocio el pez"
			   let peso6=-1
			    ;;
