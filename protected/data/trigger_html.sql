...
BEGIN
    ...
    SET NEW.html = CONCAT(
        ...
        '<p align="center" class="txt_reforesta">&nbsp;</p>',
        ...
        '</strong>',
        '<p class="txt_reforesta"><strong class="txt_cont_menusup">Generalidades</strong>. ', NEW.generalidades, '</p>',
        '<p class="txt_reforesta"><strong class="txt_cont_menusup">Distribuci&oacute;n</strong>. ', NEW.distribucion, '</p>',
        '<p class="txt_reforesta"><strong class="txt_cont_menusup">Tipo de arte de pesca</strong>. ', NEW.tipo_arte_pesca, '</p>',        
        '</td><td width="246" align="left" bgcolor="#D2CEB9" class="Utexconceptos">',
        imagenes,
        '</td></tr>',
        '</table>',
        '</div>'
