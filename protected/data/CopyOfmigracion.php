...
system("mysql --default-character-set=utf8 -h localhost -u calonso -p30113 usos < protected/data/filtros.sql");
system("mysql --default-character-set=utf8 -h localhost -u calonso -p30113 usos < protected/data/tabla_grupos.sql");
system("mysql --default-character-set=utf8 -h localhost -u calonso -p30113 usos < protected/data/tabla_carta_nacional.sql");
system("mysql --default-character-set=utf8 -h localhost -u calonso -p30113 usos < protected/data/distribucion.sql");
system("mysql -h localhost -u calonso -p30113 usos < protected/data/tabla_estado_conservacion.sql");
system("mysql --default-character-set=utf8 -h localhost -u calonso -p30113 usos < protected/data/tipo_capturas.sql");
system("mysql --default-character-set=utf8 -h localhost -u calonso -p30113 usos < protected/data/tipo_veda.sql");
//echo $db->get_id('carta_nacional', 'Nombre','id=1'));

$n = system("wc -l protected/data/BD_27_03.csv | awk '{print $1}'");
system("echo \"SET FOREIGN_KEY_CHECKS=0; \" > protected/duserata/tabla_peces_migracion.sql");
...
for($i=2;$i<=$n;$i++){
	...
	echo $i."<br>";
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$11"" }\' protected/data/BD_27_03.csv';
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$25"" }\' protected/data/BD_27_03.csv';
	...
	if($i==$n)
		$cmd = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print "(\""$1"\",\""$2"\",\""$3"\",\""$4"\",\""$5"\",\""$6"\",'.$formato_grupo.',\""$12"\","$18",\""$43"\",NULL,\""$19"\",\""$20"\",\""$21"\",'.$formato_veda.',\""$26"\",\""$27"\",\""$28"\",\""$29"\",\""$30"\",\""$31"\")" }\' protected/data/BD_27_03.csv >> protected/data/tabla_peces_migracion.sql';
	else
		$cmd = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print "(\""$1"\",\""$2"\",\""$3"\",\""$4"\",\""$5"\",\""$6"\",'.$formato_grupo.',\""$12"\","$18",\""$43"\",NULL,\""$19"\",\""$20"\",\""$21"\",'.$formato_veda.',\""$26"\",\""$27"\",\""$28"\",\""$29"\",\""$30"\",\""$31"\")," }\' protected/data/BD_27_03.csv >> protected/data/tabla_peces_migracion.sql';
...
system("mysql --default-character-set=utf8 -h localhost -u calonso -p30113 usos < protected/data/tabla_peces_migracion.sql");
...
for($i=2;$i<=$n;$i++){
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$3"" }\' protected/data/BD_27_03.csv';
...
//-----------------------------------------------------------------------------------------------------------//
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$7"" }\' protected/data/BD_27_03.csv';
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$8"" }\' protected/data/BD_27_03.csv';
	//Sí el campo Golfo de México es 1 se calcula el id en la tabla tipo_distribucion
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$9"" }\' protected/data/BD_27_03.csv';
	//Sí el campo Golfo de México es 1 se calcula el id en la tabla tipo_distribucion
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$10"" }\' protected/data/BD_27_03.csv';
	//Sí el campo Golfo de México es 1 se calcula el id en la tabla tipo_distribucion$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$37"" }\' protected/data/BD_27_03.csv';
...
//----------------------------------------------------------------------------------------------------------//	
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$13"" }\' protected/data/BD_27_03.csv';
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$14"" }\' protected/data/BD_27_03.csv';
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$15"" }\' protected/data/BD_27_03.csv';
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$16"" }\' protected/data/BD_27_03.csv';
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$17"" }\' protected/data/BD_27_03.csv';
...
//----------------------------------------------------------------------------------------------------------//
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$23"" }\' protected/data/BD_27_03.csv';
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$24"" }\' protected/data/BD_27_03.csv';
	...
	/*$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$37"" }\' protected/data/BD_27_03.csv';
...
//----------------------------------------------------------------------------------------------------------//
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$33"" }\' protected/data/BD_27_03.csv';
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$34"" }\' protected/data/BD_27_03.csv';
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$35"" }\' protected/data/BD_27_03.csv';
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$36"" }\' protected/data/BD_27_03.csv';
	...
	$cad = 'awk \'BEGIN { FS = "?"}; NR == '.$i.' {print ""$38"" }\' protected/data/BD_27_03.csv';
...
system("mysql --default-character-set=utf8 -h localhost -u calonso -p30113 usos < protected/data/tabla_pez_carta_nacional.sql");
...
system("mysql --default-character-set=utf8 -h localhost -u calonso -p30113 usos < protected/data/tabla_pez_distribucion.sql");
...
system("mysql --default-character-set=utf8 -h localhost -u calonso -p30113 usos < protected/data/tabla_pez_estado_conservacion.sql");
...
system("mysql --default-character-set=utf8 -h localhost -u calonso -p30113 usos < protected/data/tabla_pez_tipo_capturas.sql");
?>