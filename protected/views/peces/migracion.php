...
//----------------------------------------------------------------------------------------------------------//
	...
	if(strip_tags(system($cad))!=""){
		$id_cn = utf8_decode($db->get_id('carta_nacional', 'id','Nombre="'.strip_tags(system($cad)).'" AND Nivel1=1'));
		$id_cn = strip_tags($id_cn);
		$cad = 'echo "('.$id_pez.','.$id_cn.')," >> protected/data/tabla_pez_carta_nacional.sql';
		system($cad);
	}
	...
	if(strip_tags(system($cad))!=""){
		$id_cn = utf8_decode($db->get_id('carta_nacional', 'id','Nombre="'.strip_tags(system($cad)).'" AND Nivel1=2'));
		$id_cn = strip_tags($id_cn);
		$cad = 'echo "('.$id_pez.','.$id_cn.')," >> protected/data/tabla_pez_carta_nacional.sql';
		system($cad);
	}
