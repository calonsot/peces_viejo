...
<form name="buscador" id="buscador" method="get" action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/peces/resultado">
	...
	<input style="float:left; width:29%; margin-right:17px;" type="text" name="nombre_cientifico" id="buscador_nombre_cientifico" placeholder="Nombre cient&iacute;fico">
	<label for="select"></label> <?php echo CHtml::dropDownList('grupo', null, CHtml::listData(Grupo::model()->findAll(array('order'=>'nombre ASC')), 'id', 'nombre'), array('id'=>'buscador_grupo', 'prompt'=>'---Grupo---', 'style'=>'float:left; width:32%;')); ?>
	</div>
	...
	<div style="float:left; width:100%;">
		...
		<div id="recomendaciones" style="float:left; width:60%; margin-left: 30px;">
			...
			<span class="seleccionar"></span>
			<b>Poco recomendable</b><br>
			Especies que de preferencia no debes consumir ya que sus poblaciones están en un máximo aprovechamiento y de seguir consumiéndolos en exceso sus poblaciones pueden colapsarse.
			</label>
			<input type="checkbox" name="recomendacion" value="2" id="buscador_no_recomendable"><label for="buscador_no_recomendable" class="nrec">
			<span class="seleccionar"></span>
			<b>No recomendable</b><br>
