...
?>
	...
	<form name="buscador" id="buscador" method="get" action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/peces/resultado">
		...
		<div>
			Nacional <input type="checkbox" name="nacional_importado[]" id="buscador_nacional" value="0,2">
			Importado <input type="checkbox" name="nacional_importado[]" id="buscador_importado" value="1,2">
		</div>
		...
		<div style="width: 100%;text-align: left;color: #4E4D49;">
			...
			<?php echo CHtml::image(Yii::app()->request->baseUrl."/imagenes/aplicacion/pez.png", "Pez", array('class' => "pez_circulo")); ?>
			<input type="checkbox" name="recomendacion[]" value="20"
			...
			<?php echo CHtml::image(Yii::app()->request->baseUrl."/imagenes/aplicacion/pez.png", "Pez", array('class' => "pez_circulo")); ?>
			<input type="checkbox" name="recomendacion[]" value="25-200"
					id="buscador_evita">
					<hr /> <b>Evita (>20)</b>
				</label>
