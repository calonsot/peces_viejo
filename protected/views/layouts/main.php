							...
							<table id="Table_4" width="1020" border="0" cellpadding="0"
								...
								<tr>
									...
									<td align="left" valign="top" bgcolor="#6A4E1C">
										...
										<table width="911" border="0" align="center" cellpadding="0"
											cellspacing="0">
											<tr>
												<td width="591" bgcolor="#C2BDA0"><?php echo CHtml::link(CHtml::image("http://www.biodiversidad.gob.mx/usos/alimentacion/images/titPeces_02.png", "Aguacate", array("width"=>40, "height"=>301, "border"=>0, "id"=>"Aguacate", "name"=>"Aguacate")), Yii::app()->request->baseUrl); ?>
